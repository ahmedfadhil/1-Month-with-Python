...
class UserManager():
    ...
    def message_user(self, user_id=None, email=None, subject="Billing update"):
        ...
        if user:
            ...
            print(plain_, html_)
            user_email = user.get("email", "james@gmail.com")
    ...
    def get_user_data(self, user_id=None, email=None):
        ...
        with open(filename, "r") as csvfile:
            ...
            if unknown_user_id is not None:
                print("User with id: {user_id} not found".format(user_id=user_id))
            if unknown_email is not None:
                print("User with email: {email} not found".format(email=email))
